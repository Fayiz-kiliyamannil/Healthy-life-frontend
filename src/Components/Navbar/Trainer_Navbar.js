    ...
    return (
        ...
        <>
                                        ...
                                        <div className="flex items-center">
                                            <div className=" flex  flex-shrink-0">
                                                <img
                                                    ...
                                                    alt="Your Company"
                                                />
                                                <span className="text-[#fff] mt-3">Healthy-Life<span className='text-gray-400 text-sm p-1'>-Trainer</span></span>
                                            </div>
            ...
            <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
              <h1 className="text-3xl font-bold tracking-tight text-gray-900">{props.n}</h1>  
            </div>
          </header> */}
                </div>
            </div>
