...
function SpinnerColors() {
  return (
    <>
      ...
      <div className="absolute right-1/2 bottom-1/2  h-screen w-screen bg-black bg-opacity-10 flex justify-center items-center  transform translate-x-1/2 translate-y-1/2 ">
