...
<footer className=" rounded-lg shadow   m-4">
    <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        ...
        <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2020 <Link href="/home" className="hover:underline">Healthy-Life™</Link>. All Rights Reserved.</span>
    </div>
</footer>
