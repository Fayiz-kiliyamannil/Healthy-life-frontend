                    ...
                    <div className="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
                        ...
                        <div className="col-span-4  sm:col-span-9">
                            <div className="bg-[#202123] h-200px shadow   rounded-lg p-6">
                                ...
                                {
                                    props.data.about ? <p className="text-gray-400 text-sm  "> {props.data.about} </p>
                                        : <p className="text-gray-500  text-sm  ">Write something about you here..</p>
                                }
                                ...
                                <div class="grid gap-6 p-3  md:grid-cols-2">
                                    ...
                                    </div>
                                    {
                                        props.trainer ?
                                            (
                                                <div>
                                                    <label htmlFor="visitors" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"> Trainer Specialization </label>
                                                    <p class="bg-gray-50 text-gray-900 text-sm rounded-lg focus:ring-blue-500  block w-full p-2.5 dark:bg-gray-700  dark:placeholder-gray-400 dark:text-white  ">{props.data.specilized ? props.data.specilized: 'eg : yoga instructor '}</p>
                                                </div>
                                            ) :
                                            (
                                                <div>
