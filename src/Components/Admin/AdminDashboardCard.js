...
const navigate = useNavigate()
    ...
    return (
        <>
            <div className="grid px-2  grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 flex ">
                <div  onClick={()=>navigate('/admin/trainees') } className=" h-32 bg-gradient-to-r m-2 from-gray-900 to-gray-800 shadow-lg rounded-xl overflow-hidden">
                    <div className="flex items-center justify-between p-4">
                        <div className=" w-16 h-16 bg-gradient-to-r from-yellow-800 to-yellow-600 rounded-full flex items-center justify-center">
                ...
                <div onClick={()=> navigate('/admin/trainers')}  className=" h-32  bg-gradient-to-r m-2  from-gray-900 to-gray-800 shadow-lg rounded-xl overflow-hidden">
                    <div className="flex items-center justify-between p-4">
                        <div className=" w-16 h-16 bg-gradient-to-r from-cyan-800 to-cyan-600 rounded-full flex items-center justify-center">
                ...
                <div className=" h-32 bg-gradient-to-r m-2 from-gray-900 to-gray-800 shadow-lg rounded-xl overflow-hidden">
                    <div className="flex items-center justify-between p-4">
                        <div className=" w-16 h-16 bg-gradient-to-r from-red-800 to-red-600 rounded-full flex items-center justify-center">
                ...
                <div className=" h-32 bg-gradient-to-r m-2 from-gray-900 to-gray-800 shadow-lg rounded-xl overflow-hidden">
                    <div className="flex items-center justify-between p-4">
                        <div className=" w-16 h-16 bg-gradient-to-r from-pink-800 to-pink-600 rounded-full flex items-center justify-center">
