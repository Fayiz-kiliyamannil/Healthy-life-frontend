...
function Signup(props) {
  ...
  <div className='w-screen flex h-screen justify-center items-center   bg-black  bg-cover ' style={{ backgroundImage: 'url("/gym-with-treadmills-light-wall.jpg")' }} >
        <div className="  rounded-md bg-black max-sm:mt-20 bg-opacity-80 shadow-custom text-center p-[20px]  mx-auto ">
          <div className="sm:mx-auto  px-14 sm:w-full sm:max-w-sm">
          ...
          <form className="space-y-2 w-full " onSubmit={props.eventSubmit} >
              <div>
                <label htmlFor="name" className="block text-sm text-left font-medium leading-6 text-[#C2C2C2]">Name</label>
                <div className="mt-1">
                  <input id="name" name="name" type="name" value={data.name} onChange={eventHandle} required className="block w-full  rounded-full py-2 bg-[#898989] bg-opacity-20 text-[#C2C2C2] " />
                </div>
              </div>
              <div>
                <label htmlFor="email" className="block text-sm text-left font-medium leading-6 text-[#C2C2C2]">Email address</label>
                <div className="mt-1">
                  <input id="email" name="email" type="email" value={data.email} onChange={eventHandle} required className="block w-full  rounded-full py-2 bg-[#898989] bg-opacity-20  text-[#C2C2C2] " />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mt-1">
                  <input id="password" name="password" type="password" value={data.password} autoComplete="new-password" onChange={eventHandle} className="block w-full   rounded-full py-2 bg-[#898989] bg-opacity-20 text-[#C2C2C2] " />
                </div>
                <div className="flex items-center justify-between">
                ...
                <div className="mt-1">
                  <input id="repassword" name="repassword" type="password" autoComplete="re-password" value={data.repassword} onChange={eventHandle} className="block w-full   rounded-full py-2 bg-[#898989] bg-opacity-20 text-[#C2C2C2] " />
            ...
            <p className="mt-7 text-sm text-[#C2C2C2]">
              Already a user?
              <Link to="/login" className="font-semibold p-1 leading-6 text-[#FA2A55] hover:text-[#BA0C2F] hover:border-b hover:border-[#BA0C2F] "> Login</Link>
            </p>
            </form>
