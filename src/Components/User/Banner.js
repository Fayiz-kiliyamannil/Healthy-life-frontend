...
function Banner() {
 const {paymentNavigation} = useContext(usersContext)
  ...
  < div className=" bg-cover h-[600px] text-white py-24  object-fill " style={{backgroundImage: 'url(/pexels-victor-freitas-703016.jpg)'}}>
       ...
       <div className="md:w-1/2  mb-8 items-center mt-[200px]  ">
        ...
        <div className="bottom-0 w-screen  bg-gradient-to-b from-transparent via-rgba(37, 37, 37, 0.61) to-black h-[100px]"  >
    </div>
    </div>
